...
(() => {
  ...
  const ITEMS = [
    ...
    { id: 'r4',   type: 'reel', n: 4, name: 'Arizona Sports Arena', industry: 'fitness',  tile: { fx: 0.9847, fy: 0.7824, w: 0.090 }, stack: null },
    { id: 'r5',   type: 'reel', n: 5, name: 'Atlanta Industries x Ikigai', industry: 'food',  tile: { fx: 0.8646, fy: 0.4194, w: 0.130 }, stack: null },
    ...
    { id: 'r7',   type: 'reel', n: 7, name: 'Lakm&eacute; Salon — Soft Glam', industry: 'beauty',  tile: { fx: 0.0716, fy: 0.4468, w: 0.120 }, stack: { x: 0.30, y: 0.6053, w: 0.23, h: 0.3947, z: 7 } },
    { id: 'r8',   type: 'reel', n: 8, name: 'Lakm&eacute; Salon — Good Hair', industry: 'beauty',  tile: { fx: 0.9264, fy: 0.1641, w: 0.095 }, stack: null },
    { id: 'r9',   type: 'reel', n: 9, name: 'Lakm&eacute; Salon — The Glow', industry: 'beauty',  tile: { fx: 0.5909, fy: 0.7576, w: 0.110 }, stack: { x: 0.52, y: 0.5526, w: 0.16, h: 0.3684, z: 2 } },
    { id: 'r10',  type: 'reel', n: 10, name: 'hatk. — Photo Booth', industry: 'fashion', tile: { fx: 0.5839, fy: 0.5544, w: 0.085 }, stack: { x: 0.30, y: 0.0, w: 0.26, h: 0.3158, z: 8 } },
    { id: 'r11',  type: 'reel', n: 11, name: 'Rini — Shinobu Jacket', industry: 'fashion', tile: { fx: 0.1940, fy: 0.8738, w: 0.125 }, stack: null },
    { id: 'r12',  type: 'reel', n: 12, name: 'Rini — Introducing', industry: 'fashion', tile: { fx: 0.0726, fy: 0.7971, w: 0.100 }, stack: null },
    { id: 'r13',  type: 'reel', n: 13, name: 'Rini — The Collection', industry: 'fashion', tile: { fx: 0.1502, fy: 0.0951, w: 0.115 }, stack: null },
    { id: 'r14',  type: 'reel', n: 14, name: 'Rini — Five Years', industry: 'fashion', tile: { fx: 0.7781, fy: 0.4575, w: 0.090 }, stack: null },
    { id: 'r15',  type: 'reel', n: 15, name: 'Axel Public School — Every Dream', industry: 'education', tile: { fx: 0.2511, fy: 0.6442, w: 0.130 }, stack: null },
    { id: 'r16',  type: 'reel', n: 16, name: 'Axel Public School x Physics Wallah', industry: 'education', tile: { fx: 0.9994, fy: 0.9764, w: 0.105 }, stack: null },
    { id: 'r17',  type: 'reel', n: 17, name: 'Axel Public School — Cultural Symphony', industry: 'education', tile: { fx: 0.6661, fy: 0.4642, w: 0.120 }, stack: null },
    { id: 'r18',  type: 'reel', n: 18, name: 'Axel Public School — Krida Samar', industry: 'education', tile: { fx: 0.5758, fy: 0.1497, w: 0.095 }, stack: null },
    { id: 'r19',  type: 'reel', n: 19, name: 'Relax Mattresses — The Build', industry: 'interiors', tile: { fx: 0.6413, fy: 0.9536, w: 0.110 }, stack: null },
    { id: 'r20',  type: 'reel', n: 20, name: 'Emerald by Relax Mattresses', industry: 'interiors', tile: { fx: 0.1835, fy: 0.4788, w: 0.085 }, stack: null },
    { id: 'r21',  type: 'reel', n: 21, name: 'Relax Mattresses — Lasting Comfort', industry: 'interiors', tile: { fx: 0.0339, fy: 0.2256, w: 0.125 }, stack: null },
    { id: 'r22',  type: 'reel', n: 22, name: 'Lynchpin EduFest', industry: 'education', tile: { fx: 0.2920, fy: 0.4107, w: 0.100 }, stack: null },
    { id: 'r23',  type: 'reel', n: 23, name: 'Munchies — The Interrogation', industry: 'food', tile: { fx: 0.7523, fy: 0.0037, w: 0.115 }, stack: null },
    { id: 'r24',  type: 'reel', n: 24, name: 'Munchies — Signature Plates', industry: 'food', tile: { fx: 0.9851, fy: 0.4653, w: 0.090 }, stack: null },
  ...
  function layoutBases() {
    ...
    /* a card only has to be fully off one edge before it re-enters on the
       other; canvas cards carry no shadow, so a small margin is enough */
    Mx = maxW + 12; My = maxH + 12;
    /* The tile is the wrap period of the infinite canvas, so it also sets the
       ...
       These multipliers keep the fill around 56%, and the tile fractions in
