/* ============================================================
   KAZI — ORIENT CASE STUDY
   Entry fade-up after the card-to-hero transition, plus two
   slideable reel strips ("The Craft" / "The People"). Each strip:
   drag or tap a side reel to re-centre; the centre reel plays
   WITH audio once its section scrolls into view; tapping the
   centre reel toggles pause. Same behaviour as the RAB page.
   ============================================================ */
(() => {
  ...
  initReelStrip('craftRow');
  initReelStrip('peopleRow');
})();
